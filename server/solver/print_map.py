...
#     for j in range(0, old_div(grid_width, 2)):
#         location = 2 * grid_height + 2 * j * grid_height - 1
#         out += '     %s %s %s' % (north_edge_glyph(walls, location, 2),
#                                   extra_label[location], south_edge_glyph(walls, location, 0))
#     print(out)
...
#         out += '%s%s %s %s' % (top_edge_glyph(walls, base_edge_location, 1), north_edge_glyph(
#             walls, label_location, 2), top_label[label_location], south_edge_glyph(walls, label_location, 0))
#     if grid_width % 2:
...
#             out += ' %s %s %s %s' % (extra_label[extra_label_location], south_edge_glyph(
#                 walls, extra_label_location, 0), bottom_label[label_location], north_edge_glyph(walls, label_location, 5))
#         if grid_width % 2:
#             extra_label_location = grid_height - \
#                 i + (grid_width - 1) * grid_height - 1
#             out += ' %s %s' % (extra_label[extra_label_location],
#                                south_edge_glyph(walls, extra_label_location, 0))
#         print(out)
...
#             out += ' %s %s%s%s' % (top_label[label_location], south_edge_glyph(walls, label_location, 0),
#                                    top_edge_glyph(walls, edge_location, 4), north_edge_glyph(walls, edge_location, 5))
#         if grid_width % 2:
#             label_location = grid_height - i + \
#                 (grid_width - 1) * grid_height - 1
#             out += ' %s %s' % (top_label[label_location],
#                                south_edge_glyph(walls, label_location, 0))
#         print(out)
...
#             out += ' %s %s %s %s' % (bottom_label[label_location], north_edge_glyph(
#                 walls, label_location, 5), extra_label[edge_location], south_edge_glyph(walls, edge_location, 0))
#         if grid_width % 2:
#             label_location = grid_height - i + \
#                 (grid_width - 1) * grid_height - 1
#             out += ' %s %s' % (bottom_label[label_location],
#                                north_edge_glyph(walls, label_location, 5))
#         print(out)
...
#             out += '%s%s %s %s' % (top_edge_glyph(walls, base_edge_location, 4), north_edge_glyph(
#                 walls, base_edge_location, 5), top_label[label_location], south_edge_glyph(walls, label_location, 0))
#         if grid_width % 2:
#             base_edge_location = grid_height - i + \
#                 (grid_width - 1) * grid_height - 1
#             out += '%s%s' % (top_edge_glyph(walls, base_edge_location, 4),
#                              north_edge_glyph(walls, base_edge_location, 5))
#         print(out)
...
#         out += ' %s %s %s %s' % (extra_label[label_location], south_edge_glyph(
#             walls, label_location, 0), bottom_label[location], north_edge_glyph(walls, location, 5))
#     if grid_width % 2:
#         label_location = (grid_width - 1) * grid_height
#         out += ' %s %s' % (extra_label[label_location],
#                            south_edge_glyph(walls, label_location, 0))
#     print(out)
...
#         out += '%s %s %s   ' % (south_edge_glyph(walls, location, 3),
#                                 bottom_label[location], north_edge_glyph(walls, location, 5))
#     if grid_width % 2:
...
#     for j in range(0, old_div(grid_width, 2)):
#         location = j * 2 * grid_height
#         out += ' %s%s%s    ' % (south_edge_glyph(walls, location, 3), top_edge_glyph(
#             walls, location, 4), north_edge_glyph(walls, location, 5))
#     if grid_width % 2:
#         location = (grid_width - 1) * grid_height
#         out += ' %s%s%s' % (south_edge_glyph(walls, location, 3), top_edge_glyph(
#             walls, location, 4), north_edge_glyph(walls, location, 5))
